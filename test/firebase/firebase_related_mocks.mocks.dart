...
// in madmudmobile/test/firebase/firebase_related_mocks.dart.
...
import 'package:madmudmobile/data/cloud_service.dart' as _i8;
...
/// A class which mocks [CloudService].
///
/// See the documentation for Mockito's code generation for more information.
class MockCloudService extends _i1.Mock implements _i8.CloudService {
  @override
  _i5.Future<Map<String, dynamic>?> fetchOne({
  ...
  @override
  _i5.Future<List<Map<String, dynamic>>> fetchMany(
          {required String? collection}) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchMany,
